function GrowthRate = ERATO15(E,a,q0,n,n_r)
% betachi test
...
plnpsiGradNormDpsi = interp2(cr,cz,lnpsiGradNormDpsi_rz,pr,pz,interpmethod);
% ppsiGradNormDs = interp2(cs,cchi,psiGradNormDs_sc,ps,pchi,interpmethod);
% plogpsiGradNormDpsi = ppsiGradNormDs./ppsiGradNorm./(2*ps*Psi_s);

% the gradient psi direction's derivative of log r
plnrDpsi = interp2(cr,cz,lnrDpsi_rz,pr,pz,interpmethod);
...
e = 4*pr.^4./J.*(pjphi.^2./ppsiGradNorm.^2.*ppsi+...
