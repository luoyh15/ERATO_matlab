function gamma2 = growthrate(quantities)

%% equilibrium state
gamma = quantities.gamma;
Psi_s = quantities.psi_s;
%the coordinate
ps = quantities.s;
pchi = quantities.chi;
% psi
...
pbetachi = quantities.betachi;
% lnr2Dchi
plnr2Dchi = quantities.lnr2Dchi;
% lnr2Ds
plnr2Ds = quantities.lnr2Ds;
% toroidal current density
pjphi = quantities.jphi;
% pressure
pp = quantities.p;
% psi derivative of p
ppDpsi = quantities.pDpsi;
% flux function
pT = quantities.T;
% s derivative of T
pTDs = quantities.TDs;
...
pq = quantities.q;
%psi derivative of q
pqDs = 2*Psi_s*ps.*quantities.qDpsi;
% psiGrad2
ppsiGrad2 = quantities.psiGrad2;
% H defined at the ERATO paper
pH = 2*pjphi.*ppsi.*pr./(ps.*ppsiGrad2)+pTDs./pT-pqDs./pq;
% lnpsiGradNormDpsi
plnpsiGradNormDpsi = quantities.lnpsiGradNormDpsi;
% lnrDpsi
plnrDpsi = quantities.lnrDpsi;
% mass density
prho = 1;
% mesh(pr,pz,pbetachi);
% modified n
...
ppsiDr = quantities.psiDr;
ppsiDz = quantities.psiDz;
